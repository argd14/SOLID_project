...
public class Database {
    ...
    public List<AppointmentEntity> getAppoiments() {
        var appoiment1 = new AppointmentEntity(1, 5, LocalDate.now(), LocalTime.now());
        var appoiment2 = new AppointmentEntity(2, 6, LocalDate.now().plusDays(7), LocalTime.now().plusHours(1));
        var appoiment3 = new AppointmentEntity(3, 7, LocalDate.now().plusDays(14), LocalTime.now().plusHours(2));
        var appoiment4 = new AppointmentEntity(4, 8, LocalDate.now().plusDays(19), LocalTime.now().plusHours(3));
